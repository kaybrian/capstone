...
const char* ei_classifier_inferencing_categories[] = { "Low Risk", "High Risk" };

EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_8_axes[] = { 0, 1, 2, 3, 4, 5, 6 };
...
const ei_impulse_t impulse_631330_0 = {
    .project_id = 631330,
    .project_owner = "The African Leadership Univerity ",
    .project_name = "heart",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_631330_0 = ei_impulse_handle_t( &impulse_631330_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_631330_0;
